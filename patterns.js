...
// let numOfBorderRows = 8;
// for (let i = 0; i < numOfBorderRows; i++) {
//   for (let j = 0; j < i; j ++) {
//
//   }
// }
...
let numOfStarRows2 = 5;
for (let i = 0; i < numOfStarRows2; i++) {
  let rowOfStars = "";
  let rowOfSpaces = "";
  for (let j = 0; j < i; j++) {
    rowOfSpaces += "*";
