...
for (let countFrom1To20 = 0; countFrom1To20 <= 20; countFrom1To20++) {
  console.log(countFrom1To20);
}

for (let countFrom20To1 = 20; countFrom20To1 > 0; countFrom20To1--) {
  console.log(countFrom20To1);
}
...
for (let oddNumsBetween300and350 = 300; oddNumsBetween300and350 <= 350; oddNumsBetween300and350++) {
  if (oddNumsBetween300and350 % 2 == 1) {
    console.log(oddNumsBetween300and350);
  }
}
...
function countAs(str) {
  let aAcounter = 0;
  for (letterIndex = 0; letterIndex < str.length; letterIndex++) {
    if (str[letterIndex] == "A" || str[letterIndex] == "a") {
      aAcounter++;
    }
  }
  return aAcounter;
...
function arithmeticSequence(start, diff, numTerms) {
  let termNum = start;
  console.log(termNum);
  for (term = 0; term < numTerms - 1; term++) {
    console.log(termNum + diff);
    termNum += diff;
  }
}
...
function reverseString(str) {
  ...
  for (let charIndex = str.length - 1; charIndex >= 0; charIndex--) {
    reversedString = reversedString + str[charIndex];
  }
